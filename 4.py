...
def union_4(x):
    x1,x2=x
    return K.concatenate([x1,x2],axis=-2)
...
def build_model(maxlen,word_size):
    ...
    x1 = Conv1D(175,kernel_size=3,padding='same', activation='relu')(x1)
    x1 = Dropout(0.1)(x1)
    x1 = Dense(50,activation='relu')(x1)
    x1 = Dropout(0.1)(x1)


    x2 = Conv1D(175,kernel_size=3,padding='same', activation='relu')(x2)
    x2 = Dropout(0.2)(x2)
