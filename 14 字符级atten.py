...
class AttentionConatenate(OurLayer):
    ...
    def call(self, inputs):
        ...
        xu=K.reshape(xu,(K.shape(xu)[0],4,250))
        xu=self.reuse(self.o1_dense,xu)
        xu=K.softmax(xu, 1)
...
if __name__ == "__main__":
 ...
 """
    15000/15000 [==============================] - 93s 6ms/step - loss: 0.4279 - acc: 0.7948
15000/15000 [==============================] - 67s 4ms/step
acc: 0.8387999999682109 loss: 0.3672946552117666  highest: 0.8387999999682109
Epoch 2/50
15000/15000 [==============================] - 99s 7ms/step - loss: 0.3483 - acc: 0.8489
15000/15000 [==============================] - 96s 6ms/step
acc: 0.8522666666666666 loss: 0.33311238649686176  highest: 0.8522666666666666
Epoch 3/50
15000/15000 [==============================] - 104s 7ms/step - loss: 0.3220 - acc: 0.8611
15000/15000 [==============================] - 83s 6ms/step
acc: 0.8636 loss: 0.3173080727418264  highest: 0.8636
Epoch 4/50
15000/15000 [==============================] - 93s 6ms/step - loss: 0.3031 - acc: 0.8705
15000/15000 [==============================] - 95s 6ms/step
acc: 0.8664 loss: 0.3134898749907811  highest: 0.8664
"""